...
Установка на RISC-V (Orange Pi RV2) - это **приключение**! Не все пойдет гладко с первого раза.
- Сборка займет 20-30 минут
- Могут возникнуть проблемы с правами доступа
- База данных может не создаться автоматически
- NPM может быть капризным

**Но это решаемо!** См. [TROUBLESHOOTING.EN.md](../EN/TROUBLESHOOTING.EN.md) / [TROUBLESHOOTING.RU.md](TROUBLESHOOTING.RU.md)
...
- [ ] Поддержка других гипервизоров (VirtualBox, VMware)
